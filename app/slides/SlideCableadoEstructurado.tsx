...
export default function SlideCableadoEstructurado() {
 ...
 {/* Subsistemas */}
 <div className="bg-white backdrop-blur-sm rounded-lg p-8 border border-blue-200 animate-fade-in-up">
 ...
 <div className="bg-white backdrop-blur-sm rounded-lg p-8 border border-blue-200 animate-fade-in-up" style={{ animationDelay:'0.1s' }}>
 <div className="flex items-center gap-3 mb-4">
 ...
 <div className="bg-white backdrop-blur-sm rounded-lg p-8 border border-blue-200 animate-fade-in-up" style={{ animationDelay:'0.2s' }}>
 <div className="flex items-center gap-3 mb-4">
