        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          ...
          <div className="bg-white dark:bg-gray-800 backdrop-blur-sm rounded-lg p-8 border border-blue-200 dark:border-gray-700 animate-fade-in-up">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-2xl font-bold dark:text-white">Subsistemas</h2>
            </div>
            <div className="space-y-3">
              <div className="bg-white rounded p-3 border border-blue-100">
                <div className="font-semibold text-sm">1. Entrada de servicios</div>
                <div className="text-xs text-gray-600 dark:text-gray-300">Punto de demarcación con proveedor [37][38]</div>
              </div>
              <div className="bg-white rounded p-3 border border-blue-100">
                <div className="font-semibold text-sm">2. Cuarto de equipos</div>
                <div className="text-xs text-gray-600 dark:text-gray-300">Servidores, switches core, UPS</div>
              </div>
              <div className="bg-white rounded p-3 border border-blue-100">
                <div className="font-semibold text-sm">3. Backbone</div>
                <div className="text-xs text-gray-600 dark:text-gray-300">Fibra vertical entre pisos</div>
              </div>
              <div className="bg-white rounded p-3 border border-blue-100">
                <div className="font-semibold text-sm">4. Cuartos de telecom</div>
                <div className="text-xs text-gray-600 dark:text-gray-300">Patch panels, switches distribución</div>
              </div>
              <div className="bg-white rounded p-3 border border-blue-100">
                <div className="font-semibold text-sm">5. Cableado horizontal</div>
                <div className="text-xs text-gray-600 dark:text-gray-300">UTP/STP hasta 90m permanente</div>
              </div>
              <div className="bg-white rounded p-3 border border-blue-100">
                <div className="font-semibold text-sm">6. Área de trabajo</div>
                <div className="text-xs text-gray-600 dark:text-gray-300">Toma + patch cord (5m máx)</div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8">
            <div className="bg-white dark:bg-gray-800 backdrop-blur-sm rounded-lg p-8 border border-blue-200 dark:border-gray-700 animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-2xl font-bold dark:text-white">Mejores Prácticas</h2>
              </div>
            ...
            <div className="bg-white dark:bg-gray-800 backdrop-blur-sm rounded-lg p-8 border border-blue-200 dark:border-gray-700 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
              <div className="flex items-center gap-3 mb-4">
                <ShieldCheck className="text-blue-600 dark:text-blue-400" size={32} />
                <h2 className="text-2xl font-bold dark:text-white">Certificación</h2>
              </div>
              <div className="space-y-2 text-sm">
                <div className="flex justify-between items-center bg-white rounded p-2">
                  <span className="font-semibold">NEXT/PSNEXT</span>
                  <span className="text-gray-600 dark:text-gray-300">Crosstalk</span>
                </div>
                <div className="flex justify-between items-center bg-white rounded p-2">
                  <span className="font-semibold">Return Loss (RL)</span>
                  <span className="text-gray-600 dark:text-gray-300">Impedancia</span>
                </div>
                <div className="flex justify-between items-center bg-white rounded p-2">
                  <span className="font-semibold">ACR-F</span>
                  <span className="text-gray-600 dark:text-gray-300">Relación señal/ruido</span>
                </div>
                <div className="flex justify-between items-center bg-white rounded p-2">
                  <span className="font-semibold">Delay Skew</span>
                  <span className="text-gray-600 dark:text-gray-300">Sincronización</span>
                </div>
                <div className="flex justify-between items-center bg-white rounded p-2">
                  <span className="font-semibold">Atenuación</span>
                  <span className="text-gray-600 dark:text-gray-300">Pérdida señal</span>
                </div>
              </div>
