    ...
    <div className="relative w-full min-h-screen text-foreground bg-background font-sans overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 py-4 md:py-8">
        ...
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 md:mb-8 animate-fade-in-up flex items-center gap-2 md:gap-4">
          <TrendingUp size={32} className="sm:w-10 sm:h-10 text-blue-600 dark:text-blue-400" />
          ...
          <div className="space-y-12">
            ...
            <div className="relative grid grid-cols-2 gap-8 items-center">
              <div className="text-right animate-fade-in-up">
                <div className="bg-white dark:bg-gray-800 rounded-lg p-6 border border-blue-200 dark:border-gray-700 shadow-sm inline-block">
                  <div className="text-sm text-blue-600 dark:text-blue-400 font-semibold mb-2">1980s</div>
                  <h3 className="text-xl font-bold mb-2">Coaxial (10BASE2/5)</h3>
                  <p className="text-gray-600 dark:text-gray-300 text-sm">10 Mbps, topología bus, hasta 185m/500m</p>
                </div>
              </div>
              <div></div>
            ...
            <div className="relative grid grid-cols-2 gap-8 items-center">
              ...
              <div className="animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
                <div className="bg-white dark:bg-gray-800 rounded-lg p-6 border border-blue-200 dark:border-gray-700 shadow-sm inline-block">
                  <div className="text-sm text-blue-600 dark:text-blue-400 font-semibold mb-2">1990s</div>
                  <h3 className="text-xl font-bold mb-2">Par Trenzado Cat3/Cat5</h3>
                  <p className="text-gray-600 dark:text-gray-300 text-sm">10/100 Mbps, RJ45, topología estrella</p>
                </div>
              </div>
              <div className="absolute left-1/2 transform -translate-x-1/2 w-4 h-4 bg-blue-600 rounded-full"></div>
            </div>
            ...
            <div className="relative grid grid-cols-2 gap-8 items-center">
              <div className="text-right animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                <div className="bg-white dark:bg-gray-800 rounded-lg p-6 border border-blue-200 dark:border-gray-700 shadow-sm inline-block">
                  <div className="text-sm text-blue-600 dark:text-blue-400 font-semibold mb-2">2000s</div>
                  <h3 className="text-xl font-bold mb-2">Cat5e/Cat6 + Fibra OM1-OM3</h3>
                  <p className="text-gray-600 dark:text-gray-300 text-sm">1G/10G Ethernet, fibra multimodo para backbone</p>
                </div>
              </div>
              <div></div>
              <div className="absolute left-1/2 transform -translate-x-1/2 w-4 h-4 bg-blue-600 rounded-full"></div>
            ...
            <div className="relative grid grid-cols-2 gap-8 items-center">
              ...
              <div className="animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
                <div className="bg-white dark:bg-gray-800 rounded-lg p-6 border border-blue-200 dark:border-gray-700 shadow-sm inline-block">
                  <div className="text-sm text-blue-600 dark:text-blue-400 font-semibold mb-2">2010s</div>
                  <h3 className="text-xl font-bold mb-2">Cat6A/Cat7 + SMF OS2</h3>
                  <p className="text-gray-600 dark:text-gray-300 text-sm">10GBASE-T, 40G/100G fibra, PoE++</p>
                </div>
              </div>
              <div className="absolute left-1/2 transform -translate-x-1/2 w-4 h-4 bg-blue-600 rounded-full"></div>
            </div>
            ...
            <div className="relative grid grid-cols-2 gap-8 items-center">
              <div className="text-right animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
                <div className="bg-gradient-to-r from-blue-50 to-blue-100 rounded-lg p-6 border-2 border-blue-400 shadow-lg inline-block">
                  <div className="text-sm text-blue-600 dark:text-blue-400 font-semibold mb-2">2020s - Actualidad</div>
                  <h3 className="text-xl font-bold mb-2">Cat8 + 200G/400G/800G Fibra</h3>
                  <p className="text-gray-600 dark:text-gray-300 text-sm">40G cobre datacenter, coherente ZR/ZR+, TSN</p>
                </div>
              </div>
              <div></div>
